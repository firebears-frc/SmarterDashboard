...
public class DashboardPanel extends JPanel {
	...
	/**
	 * Adds the field of the given name to the screen. The field does not
	 * need to be in the SmarterDashboard table. This will add some default
	 * widget (for that type) with no value.
	 *
