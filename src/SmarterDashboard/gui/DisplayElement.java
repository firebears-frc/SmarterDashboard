...
/**
 * This class is the super class of everything which can be seen on the SmarterDashboard
...
public abstract class DisplayElement extends JPanel implements PropertyHolder {
	 ...
	 *
	 * <p>An obstruction is any object which the SmarterDashboard should automatically
	 * try to avoid when placing new {@link DisplayElement DisplayElements}.
	 * Pretty much everything is an obstruction except for {@link SmarterDashboard.SmarterDashboard.src.gui.elements.Image Images}
	 ...
	 *
	 * <p>An obstruction is any object which the SmarterDashboard should
	 * automatically try to avoid when placing new
	 * {@link DisplayElement DisplayElements}.
	 * Pretty much everything is an obstruction except for
	 * {@link SmarterDashboard.SmarterDashboard.src.gui.elements.Image Images}
	 * because images will sometimes be used for background effect, in which
	 * case it is fine if a new {@link DisplayElement} spawns over it.</p>
